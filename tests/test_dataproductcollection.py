...
def test_create_dataproduct_101(postman_api, postman_workspace):
    ...
    collection_id = postman_workspace.create_collection(f'🔢 Test Data Product 101 {datetime.now().isoformat()}', 'https://schema.getpostman.com/json/collection/v2.1.0/collection.json')
